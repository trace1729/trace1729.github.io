![image-20230701170904832](https://fast.itbaima.net/2023/07/01/FyOIH7ZU5sE2gen.png)image-20230701170904832
...
![image-20230701174518205](https://fast.itbaima.net/2023/07/01/W3oCIbqvLUn492J.png)image-20230701174518205

在2017年，一款名叫WannaCry的勒索软件席卷全球，导致全球大量计算机受到影响，得益于全球网络的发达，这款病毒从小规模很快发展至全球范围，勒索病毒是自熊猫烧香以来影响力最大的病毒之一。

> WannaCry（又叫Wanna Decryptor），一种“蠕虫式”的[勒索病毒](https://baike.baidu.com/item/%E5%8B%92%E7%B4%A2%E7%97%85%E6%AF%92/16623990?fromModule=lemma_inlink)软件，大小3.3MB，由不法分子利用[NSA](https://baike.baidu.com/item/NSA/1128824?fromModule=lemma_inlink)（National Security Agency，[美国国家安全局](https://baike.baidu.com/item/%E7%BE%8E%E5%9B%BD%E5%9B%BD%E5%AE%B6%E5%AE%89%E5%85%A8%E5%B1%80/300052?fromModule=lemma_inlink)）泄露的危险漏洞“EternalBlue”（永恒之蓝）进行传播 \[1\] 。勒索病毒肆虐，俨然是一场全球性互联网灾难，给广大电脑用户造成了巨大损失。最新统计数据显示，100多个国家和地区超过10万台电脑遭到了勒索病毒攻击、感染。 \[2\] 勒索病毒是自熊猫烧香以来影响力最大的[病毒](https://baike.baidu.com/item/%E7%97%85%E6%AF%92/4811584?fromModule=lemma_inlink)之一。WannaCry勒索病毒全球大爆发，至少150个国家、30万名用户中招，造成损失达80亿美元，已经影响到金融，能源，医疗等众多行业，造成严重的危机管理问题。

![image-20230701175101126](https://fast.itbaima.net/2023/07/01/wBdynQcKU2g7LjN.png)image-20230701175101126
...
![image-20230701175235964](https://fast.itbaima.net/2023/07/01/5aHJDMTiLOSzERn.png)image-20230701175235964
...
![image-20230701184920238](https://fast.itbaima.net/2023/07/01/7jW5Nzki8urUhaf.png)image-20230701184920238
...
![image-20230701224909319](https://fast.itbaima.net/2023/07/01/khHj6YqSJimGKec.png)image-20230701224909319

### CSRF跨站请求伪造攻击

CSRF是我们要介绍的第一种攻击形式，这种攻击方式非常好理解。

![image-20230701181244150](https://fast.itbaima.net/2023/07/01/4ibrwFIPnSE81lx.png)image-20230701181244150
...
![image-20230701233127287](https://fast.itbaima.net/2023/07/01/4wQ2iB5uhcLMJHa.png)image-20230701233127287

接着我们假装自己上当，进入到我们的钓鱼网站：

![image-20230701233202016](https://fast.itbaima.net/2023/07/01/OstNZg4doCz6S5G.png)image-20230701233202016

现在我们毫不知情，如果是正常人思维的话，就会直接点击下载全套视频，恭喜，此时后台已经转账成功了，留下一脸懵逼的你：

![image-20230701233317019](https://fast.itbaima.net/2023/07/01/mtGLhuNHxPUr6Os.png)image-20230701233317019
...
![a3421f74c3cee6b67d214809adb743a5](https://fast.itbaima.net/2023/07/01/qiLDnrFyQxpt3UB.png)a3421f74c3cee6b67d214809adb743a5
...
![image-20230702001501063](https://fast.itbaima.net/2023/07/02/LFchsWkevUwb58E.png)image-20230702001501063
...
![image-20230702001831904](https://fast.itbaima.net/2023/07/02/d4YSeut3xQ7rRqh.png)image-20230702001831904

可以看到此时用户的浏览器JSESSIONID值为刚刚恶意网站伪造的值，现在我们来进行登录操作：

![image-20230702002007450](https://fast.itbaima.net/2023/07/02/aDwTcW6d58tPLBG.png)image-20230702002007450
...
![image-20230702002624508](https://fast.itbaima.net/2023/07/02/8IaHk2FEMwyoXem.png)image-20230702002624508
...
![image-20230702003831742](https://fast.itbaima.net/2023/07/02/jTcOaNdwDeP9qB2.png)image-20230702003831742
...
![image-20230702004827194](https://fast.itbaima.net/2023/07/02/DkzJWPxQ5BUl2tC.png)image-20230702004827194
...
![image-20230702135644834](https://fast.itbaima.net/2023/07/02/dWkGc5YhNAIbP8j.png)image-20230702135644834
...
![image-20230702144938540](https://fast.itbaima.net/2023/07/02/tSGxZmv6jUDMy95.png)image-20230702144938540

登录成功后，就可以访问到我们之前的界面了：

![image-20230702145011992](https://fast.itbaima.net/2023/07/02/Z8fxKehX26AMaJI.png)image-20230702145011992

并且为了防止我们之前提到的会话固定问题，在登录之后，JSESSIONID会得到重新分配：

![image-20230703192441811](https://fast.itbaima.net/2023/07/03/mQpWZMljCt2XTd7.png)image-20230703192441811

当我们想要退出时，也可以直接访问：[http://localhost:8080/mvc/logout](http://localhost:8080/mvc/logout) 地址，我们会进入到一个退出登录界面：

![image-20230702145432892](https://fast.itbaima.net/2023/07/02/iHQy63RxgUkvKsw.png)image-20230702145432892
...
![image-20230702151123338](https://fast.itbaima.net/2023/07/02/yuYe5pODwqBTQh7.png)image-20230702151123338
...
![image-20230702152150157](https://fast.itbaima.net/2023/07/02/Vacp97MlgfNrYnR.png)image-20230702152150157

![image-20230702152216162](https://fast.itbaima.net/2023/07/02/tk5pGDrNHWfaJXU.png)image-20230702152216162

这样，一个简单的权限校验就配置完成了，是不是感觉用起来还是挺简单的？

不过，可能会有小伙伴发现，所有的POST请求都被403了：

![image-20230702183040922](https://fast.itbaima.net/2023/07/02/F94URzLh6oIBrCJ.png)image-20230702183040922
...
![image-20230702181131252](https://fast.itbaima.net/2023/07/02/VG19mSConefsilH.png)image-20230702181131252

![image-20230702181119809](https://fast.itbaima.net/2023/07/02/6uqerwFo13p9jxJ.png)image-20230702181119809

我们可以直接尝试进行登录，使用方式和之前是完全一样的：

![image-20230702181211157](https://fast.itbaima.net/2023/07/02/dVM5ltzF1ua8Y3E.png)image-20230702181211157
...
![image-20230703001525592](https://fast.itbaima.net/2023/07/03/akAtDrPeMdc6N3b.png)image-20230703001525592
...
![image-20230703181046326](https://fast.itbaima.net/2023/07/03/ln4uZ1TFIe7qaCK.png)image-20230703181046326

随便插入一点数据：

![image-20230703152719655](https://fast.itbaima.net/2023/07/03/tToR2JPykeuCK73.png)image-20230703152719655
...
![image-20230703180438190](https://fast.itbaima.net/2023/07/03/hpZs1DLESojHJue.png)image-20230703180438190
...
![image-20230703182321093](https://fast.itbaima.net/2023/07/03/Zns4Vwb7zPLc6SQ.png)image-20230703182321093
...
![image-20230703184425313](https://fast.itbaima.net/2023/07/03/c38kewdxtn1j2V6.png)image-20230703184425313

但是我们发现，我们的页面只有一个纯文本，这是因为在获取静态资源的时候，所有的静态资源默认情况下也会被拦截，因此全部被302重定向到登录页面，这显然是不对的：

![image-20230703184641792](https://fast.itbaima.net/2023/07/03/6vXlPZprzjJLEeq.png)image-20230703184641792
...
![image-20230703185027927](https://fast.itbaima.net/2023/07/03/LmZbihzD4vYB5GF.png)image-20230703185027927
...
![image-20230703185916404](https://fast.itbaima.net/2023/07/03/P2LS8uNRQ64WEvT.png)image-20230703185916404
...
![image-20230703190714519](https://fast.itbaima.net/2023/07/03/yM8TOAxYPf3iqFs.png)image-20230703190714519
...
![image-20230704211415804](https://fast.itbaima.net/2023/07/04/3wOt7CldbFP8yHz.png)image-20230704211415804

此时提交的表单中就已经包含记住我字段了，我们会发现，服务端返回给我们了一个记住我专属的Cookie信息：

![image-20230704211611369](https://fast.itbaima.net/2023/07/04/NB129h7IKRycXvL.png)image-20230704211611369
...
![image-20230704220701000](https://fast.itbaima.net/2023/07/04/kIJpuWdiEGqUKBx.png)image-20230704220701000
...
![image-20230704222032360](https://fast.itbaima.net/2023/07/04/e1IXMRgawYoGvSQ.png)image-20230704222032360
...
![image-20230704222733082](https://fast.itbaima.net/2023/07/04/1pkfGS9LrsPtjFx.png)image-20230704222733082
...
![image-20230704223248124](https://fast.itbaima.net/2023/07/04/8aoGrM9mpYt6Xie.png)image-20230704223248124

这是因为我们前面配置的是user角色，那么这个角色只能访问首页，其他的都不行，所以就会被自动拦截掉了。现在我们可以到数据库中对这个用户的角色进行修改，看看修改后是否能够访问到其他页面：

![image-20230704223503682](https://fast.itbaima.net/2023/07/04/l9YkDaRJdtrmSZj.png)image-20230704223503682
...
![image-20230705005303736](https://fast.itbaima.net/2023/07/05/LVxihksHZu2qN6X.png)image-20230705005303736
...
![image-20230706215806040](https://fast.itbaima.net/2023/07/06/uPjdsgbhv9NqA8B.png)image-20230706215806040
